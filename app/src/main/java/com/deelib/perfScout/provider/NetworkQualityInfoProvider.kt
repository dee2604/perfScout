...
import com.deelib.perfScout.model.NetworkQualityInfo
...
internal object NetworkQualityInfoProvider {
    internal fun getNetworkQualityInfo(context: Context): NetworkQualityInfo {
            ...
            when {
                networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI) -> {
                    ...
                    signalStrength = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        ...
                        // Fallback: use deprecated WifiManager.connectionInfo.rssi for pre-Q devices
                ...
                networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR) -> {
                    ...
                    signalStrength = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        telephonyManager.signalStrength?.level ?: 0 // 0-4 (Q+)
                    } else {
                        // Fallback: not available pre-Q, set to null
                        null
                    }
                    networkSpeed = when {
                        networkCapabilities.linkDownstreamBandwidthKbps >= 100000 -> "VERY_FAST"
        ...
        // Remove ping operations that cause ANR - use estimated values based on connection type
        ...
        // Determine stability and quality score
